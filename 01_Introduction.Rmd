...
## Ejercicios
1. ¿Qué carterísticas debe tener un conjunto de datos para considerarse una serie de tiempo?
...
3. Utilizar los datos en el objeto "AirPassengers" que corresponden a 144 mediciones del número de pasajeros mensuales en líneas aereas y:
...
4. Seleccione un conjunto de datos de algún tema de su interes, plantee un problema/pregunta que quiera responder con sus datos utilizando análisis de series de tiempo.  
