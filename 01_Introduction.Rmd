...
Se recomienda la lectura de la sección [Descomposición](https://rstudio-pubs-static.s3.amazonaws.com/1071417_80a972e9e36f4e95b54e444ac18a89d3.html#descomposici%C3%B3n) para ver un ejemplo aplicado de la descomposición de series de tiempo, ya sea con la función `decompose()`, o la famosa función `stl()`. Además, pueden existir casos en que no se tenga suficiente información para descomponer una serie, por lo que se pueden utilizar otras alternativas como la mostrada en el apartado [Un caso curioso](https://rstudio-pubs-static.s3.amazonaws.com/1071417_80a972e9e36f4e95b54e444ac18a89d3.html#un-caso-curioso) del mismo blog, en donde se utilizan las transformaciones de Fourier para obtener una descomposición temporal.
