...
$$X_{t}=T_{t}+E_{t}+I_{t}$$
Mientras que la serie se tiempo en un esquema multiplicativo se expresaría como:
...
## Ejercicios
1. Una serie de tiempo se puede descomponer en: (Seleccione la opción correcta)
...
2. Utilizar los datos en el objeto "AirPassengers" que corresponden a 144 mediciones del número de pasajeros mensuales en líneas aereas y:
a) Grafique la serie de tiempo y describa que patrón observa
b) Aplique la función decompose a los datos y describa los hallazgos
c) Grafique la serie de los logartimos de los datos y describa el cambio observado respecto a lo visto en el inciso a)
