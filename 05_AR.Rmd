...
En la sección [Identificación y modelación lineal](https://rstudio-pubs-static.s3.amazonaws.com/1071417_43ae3ecf24b84bd2ad6a0d0f9a05d019.html#identificaci%C3%B3n-y-modelaci%C3%B3n-lineal) se muestra el uso de R para la creación de modelos de lineales en series de tiempo y en particular en el apartado [AR](https://rstudio-pubs-static.s3.amazonaws.com/1071417_43ae3ecf24b84bd2ad6a0d0f9a05d019.html#arp) se estudia el comportamiento del proceso autoregresivo.
...
2. En el modelo $Y_t=0.3-0.5Y_{t-1}+0.2\epsilon_t$ con $\epsilon_t\sim N(0,1)$ la $COV(Y_t,Y_{t-1})$ es cero, es decir $\gamma_2=0$ (el valor de la variable al tiempo $t$ no esta afectada por el valor que tomó la variable 2 tiempos atrás)
